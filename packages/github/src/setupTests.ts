...
//   getItem: (key) => {
//     switch (key) {
//       case 'dm_dbs_schema': return '{"pet":[{"name":"dogs","columns":[{"id":"name","name":"Name","type":"STRING","primary":true,"placeholder":"Please fill name"},{"id":"age","name":"Age","type":"NUMBER"},{"id":"color","name":"Color","ui:createUpdatePage:enum":["white","black"],"type:createUpdatePage":"RadioGroup"}]}],"iam":[{"name":"users","columns":[{"id":"userId","name":"User ID","primary":true},{"id":"name","name":"Name"}]}]}';
